...
echo_and_run cd "/home/ss/hcx/nav_ws/src/rbx1/rbx1_nav"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python2" \
    "/home/ss/hcx/nav_ws/src/rbx1/rbx1_nav/setup.py" \
    build --build-base "/home/ss/hcx/nav_ws/build/rbx1/rbx1_nav" \
    install \
    --root="${DESTDIR-/}" \
