...
echo_and_run cd "/home/ss/hcx/nav_ws/src/arbotix_ros/arbotix_python"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python2" \
    "/home/ss/hcx/nav_ws/src/arbotix_ros/arbotix_python/setup.py" \
    build --build-base "/home/ss/hcx/nav_ws/build/arbotix_ros/arbotix_python" \
    install \
    --root="${DESTDIR-/}" \
