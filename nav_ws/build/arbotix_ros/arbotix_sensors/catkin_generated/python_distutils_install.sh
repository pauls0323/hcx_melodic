...
echo_and_run cd "/home/ss/hcx/nav_ws/src/arbotix_ros/arbotix_sensors"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python2" \
    "/home/ss/hcx/nav_ws/src/arbotix_ros/arbotix_sensors/setup.py" \
    build --build-base "/home/ss/hcx/nav_ws/build/arbotix_ros/arbotix_sensors" \
    install \
    --root="${DESTDIR-/}" \
